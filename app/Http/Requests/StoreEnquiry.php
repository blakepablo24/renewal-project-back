...
class StoreEnquiry extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'enquiryPhone' => 'required|string',
            'enquiryData' => 'required|string',
            'subject' => 'required|string',
            'transportService' => 'nullable|string',
            'enquiryCollectionAddress' => 'nullable|string',
            'enquiryDeliveryAddress' => 'nullable|string',
            'enquiryDate' => 'nullable|string',
